...
args <-"doc/20190814_scRNAseq_info.xlsx"
...
if(is.na(args[2])){
        ...
        write.csv(QC.list,paste0(path,"RO2_3119_QC_list.csv"))
...
object %<>% subset(subset = nFeature_RNA > 700  & nCount_RNA > 1500 & percent.mt < 10)
